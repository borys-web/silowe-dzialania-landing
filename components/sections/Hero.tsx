...
/**
 * Sekcja 1 — Hero.
 * Warstwy: tło (#08090D + grid + czerwony glow) → Wiktor → szklana karta z treścią.
...
export function Hero() {
  ...
  const handleMouseMove = useCallback(
    ...
    [isDesktop, reduceMotion, mouseX, mouseY],
  );
  ...
  return (
    ...
    >
      ...
      {/* Mobile — Wiktor jako przyciemnione tło pod kartą */}
      ...
      {/* Warstwa 1 — Wiktor (desktop) */}
      <motion.div
        className="hero-wiktor-desktop"
        aria-hidden
      ...
      {/* Warstwa 2 — szklana karta */}
      <div className="relative z-20 mx-auto w-full max-w-6xl py-20 sm:py-24">
        <motion.div
