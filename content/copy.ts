...
export const copy = {
  ...
  textReviews: {
    ...
    intro: "Prawdziwe głosy uczestników — luźno, bez scenariusza.",
    items: [
      {
        name: "Uczestniczka kursu",
        avatar: "/images/reviews/avatar-1.png",
        avatarPosition: "14% 94%",
        rotate: -1.5,
        layout: "a",
        paragraphs: [
      ...
      {
        name: "Uczestnik kursu",
        avatar: "/images/reviews/avatar-2.png",
        avatarPosition: "10% 96%",
        rotate: 1,
        layout: "b",
        paragraphs: [
          ...
          "1) Zdefiniowanie problemu (bo od tego należy zacząć); 2) Zbudowanie systemu do zarządzania swoim czasem; 3) Lepsze poznanie siebie i swoich możliwości.",
          "Myślę, że dziś — dzięki bardziej realistycznemu podejściu do planowania — jestem w stanie osiągnąć **znacznie lepsze efekty**, jednocześnie mniej się przy tym męcząc. Jako praktyk — **serdecznie polecam**.",
        ],
      },
      {
        name: "Uczestniczka kursu",
        ...
        layout: "c",
        paragraphs: [
          "Przed kursem miałam trochę chaos w życiu i planowaniu. Wydawało mi się, że planuję dobrze, ale tak naprawdę planowałam za intensywnie i w ogóle nie zostawiałam sobie miejsca na odpoczynek. Przez 2–3 miesiące działałam na pełnych obrotach, a później organizm po prostu mnie odcinał. Nie zdawałam sobie sprawy, że po prostu **wyczerpuję swoje zasoby**.",
          "Dzięki Wiktorowi nauczyłam się zarządzać zasobami i zrozumiałam, że ich ilość jest ograniczona. Dziś pracuję i żyję dużo bardziej wydajnie — **bez takich zjazdów jak wcześniej**.",
        ],
      },
      {
        name: "Uczestnik kursu",
        avatar: "/images/reviews/avatar-4.png",
        avatarPosition: "12% 93%",
        rotate: 1.2,
        layout: "d",
        paragraphs: [
          "Planowanie — temat rzeka. Robiłem dużo podejść i zawsze kończyło się tak samo: czułem, że zawodzę. Wszystko zmieniło się, gdy Wiktor pokazał mi, jak tak naprawdę powinno się planować. Tu nie liczy się ilość zadań, ale **priorytety**.",
          "Teraz planuję każdy tydzień. Plan jest elastyczny — nie jestem niewolnikiem planu, ale dzięki niemu wiem, co mam robić. To daje **jasność działania i zmniejsza poziom stresu**. Dzięki Wiktor 👊",
        ],
      },
    ],
  },
